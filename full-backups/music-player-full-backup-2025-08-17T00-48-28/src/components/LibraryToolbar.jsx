...
export const LibraryToolbar = ({
  ...
  return (
    <div className="flex flex-wrap gap-3 w-full md:w-auto mb-4">
      ...
      </div>\n\n      {/* Online tracks toggle */}
      <button
        onClick={onToggleOnlineTracks}
        ...
        style={{
          backgroundColor: showOnlineTracks
            ? "var(--accent-color)"
            : "var(--bg-secondary)",
          borderColor: "var(--border-color)",
        }}
        title={showOnlineTracks ? "Hide online tracks" : "Show online tracks"}
      >
        <FaGlobe className="mr-2" />
        {showOnlineTracks ? "Online On" : "Online Off"}
      </button>
